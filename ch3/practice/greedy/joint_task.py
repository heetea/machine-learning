...
def main():
    ...
    # dps = dynamic_programming_search.DynamicProgrammingSearch(ve - word_segmentation.py 및 vowel_insertion.py 과 달리 succ_and_cost 에서 이중 루프(doubly nested loop)를 사용해야 함.
    #- 첫번째 루프 안에서는 text를 쪼개서 단어를 만듬
    #- 두번째 루프 안에서는 모음을 삽입
    #- succ_and_cost 의 코드가 대략 6~10 줄 정도가 필요할 것으로 생각됨.rbose=1)
